    ...
    <div className="content-grid">
      ...
      <div className="prose about-story">
        <section>
          ...
          <p>I’m the <strong>Founder and Community Lead of APICon Tanzania</strong>, President of Cyber Club DIT, and a Zone Labs(CTF) Ambassador at DIT. I also contribute to the NICE Cyber Careers Community of Interest and serve in the DIT–CEBOT Horizons Alliance. Across these roles, I focus on practical security education, developer communities, and creating opportunities for people entering technology and cybersecurity.</p>
        </section>
